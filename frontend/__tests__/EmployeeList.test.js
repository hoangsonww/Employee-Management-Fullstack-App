...
describe('<EmployeeList />', () => {
  ...
  it('shows warning snackbar when not logged in and redirects on Login click', () => {
    render(
    ...
    expect(
      screen.getByText(/You must be logged in to access the employee list/i)
    ).toBeInTheDocument();
  ...
  it('deletes an employee when Delete is clicked', async () => {
    ...
    empService.getAllEmployees.mockImplementation(() =>
      Promise.resolve(currentEmps)
    );
