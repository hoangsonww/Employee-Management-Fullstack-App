...
if (db.departments.countDocuments() > 0) {
  print(
    "  ⚠ Data already exists — skipping seed. Drop collections first to re-seed.",
  );
...
const employees = [
  ...
  },
  {
    firstName: "Quinn",
    lastName: "Martinez",
    email: "quinn.martinez@company.com",
    age: 29,
    dept: "Operations",
  },
  {
